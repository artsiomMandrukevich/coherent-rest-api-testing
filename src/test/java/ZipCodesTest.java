...
public class ZipCodesTest extends BaseTest {
    ...
    @Order(1)
    @DisplayName("Scenario #1. Task 20. Get all available zip codes in the application for now.")
    @Test()
    ...
    @Order(2)
    @DisplayName("Scenario #2. Task 20. Zip codes from request body are added to available zip codes of application.")
    @Test()
    ...
    @Order(3)
    @DisplayName("Scenario #3. Task 20. Zip codes from request body are added to available zip codes of application. There are no duplications in available zip codes")
    @Test()
    ...
    @Order(4)
    @DisplayName("Scenario #4. Task 20. Zip codes from request body are added to available zip codes of application. There are no duplications between available zip codes and already used zip code")
    @Test()
