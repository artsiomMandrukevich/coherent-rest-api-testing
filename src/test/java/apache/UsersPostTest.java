...
public class UsersPostTest extends BaseTest {
    ...
    void usersPostAllFieldsTest() {
        ...
        assertThat(clientZipCodes.sendGetZipCodes(200).getZipCodes()).doesNotContain(expectedZipCodes.get(0));
    }
    ...
    void usersPostDuplicateUserTest() {
        ...
        clientZipCodes.sendPostZipCodes(zipCodes, 201);
        ...
        // assert that User is not added to application
        assertFalse(clientUsers.sendGetUsers().contains(duplicateUser));
    }
